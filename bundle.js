(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.code = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
...
},{"./parser.js":3,"raphael":2}],2:[function(require,module,exports){
...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$startRuleFunctions = { MergeStack: peg$parseMergeStack },
      peg$startRuleFunction  = peg$parseMergeStack,
      ...
      peg$c7 = function(stack, shiftx, shifty) {
        console.log(shiftx);
        return {"op": "shift", "child":stack, "value": [shiftx, shifty]};
        },
      peg$c8 = "@",
      peg$c9 = peg$literalExpectation("@", false),
      peg$c10 = function(stack, rotate) {
  ...
  function peg$parseMergeStack() {
    var s0, s1, s2, s3, s4, s5;

    s0 = peg$currPos;
    s1 = peg$parseCompleteStack();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
  ...
  function peg$parseCompleteStack() {
    var s0;

    s0 = peg$parseShiftStack();
    if (s0 === peg$FAILED) {
      s0 = peg$parseRotateStack();
      if (s0 === peg$FAILED) {
        s0 = peg$parseLayer();
      }
    }
